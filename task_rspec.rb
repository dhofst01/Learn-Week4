...
#
  ...
  it "item can be added with date to tasklist" do
    newTasklist = Tasklist.new
    task1 = DueDateTask.new("pay bills", "done", "19-4-2017")
    expect{newTasklist.addTask(task1)}.to_not raise_error
  end
  ...
  duedate = DueDateTask.new("clean room", "not done",'19-4-2018')
  duedate2 = DueDateTask.new("clean car", "done",'19-4-2019')
  duedate2 = DueDateTask.new("pay taxes", "not done",'19-5-2019')
